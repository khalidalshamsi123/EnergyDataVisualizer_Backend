...
from utils.methods import get_averages_for_columns_including_word, get_averages_for_columns_including_word_regex
...
@router.get("/api/Energy_efficiency_improvements_costs_LA/average/dwelling_type")
async def get_average_EE_improvement_costs_per_dwelling():
    ...
    return average_ee_improvement_costs_per_dwelling_type

@router.get('/api/Energy_efficiency_improvements_costs_LA/average/heating_type')
async def get_average_EE_improvement_costs_per_heating_type():
    ...
    return average_ee_improvement_costs_per_heating_type